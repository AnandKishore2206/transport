...
import com.infy.transport.web.rest.errors.BadRequestAlertException;
import com.infy.transport.web.rest.util.HeaderUtil;
...
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "transportCustomer";
